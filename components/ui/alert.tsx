// shadcn/ui Alert component (adapted to this project's CSS variable convention,
// same as components/ui/popover.tsx and badge.tsx)
...
const alertVariants = cva("relative rounded-lg border", {
  variants: {
    ...
    isNotification: {
      true: "z-[100] max-w-[400px] bg-[--bg-elevated] shadow-lg shadow-black/5",
      false: "",
    },
  },
  defaultVariants: {
